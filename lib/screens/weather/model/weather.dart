...
class Location {
  ...
  factory Location.fromJSON(Map<String, dynamic> parsedJson) {
    return Location(
        name: parsedJson['name'], localTime: parsedJson['localtime']);
  }
  String name;
  String localTime;
}
...
class Conditions {
  ...
  factory Conditions.fromJSON(Map<String, dynamic> parsedJson) {
    return Conditions(text: parsedJson['text'], icon: parsedJson['icon']);
  }
  String text;
  String icon;
}
...
class Forecast {
  ...
  factory Forecast.fromJSON(Map<String, dynamic> parsedJson) {
    return Forecast(
        forecastdays: (parsedJson['forecastday'] as List)
...
class Forecastday {
  ...
  factory Forecastday.fromJSON(Map<String, dynamic> parsedJson) {
    return Forecastday(day: Day.fromJSON(parsedJson['day']));
  }
  Day day;
}

class Day {
  Day({required this.minTemp, required this.maxTemp});

  factory Day.fromJSON(Map<String, dynamic> parsedJson) {
    return Day(
        minTemp: parsedJson['mintemp_c'], maxTemp: parsedJson['maxtemp_c']);
  }
  double minTemp;
  double maxTemp;
}
